...
class Markov implements IPredictor {
...
const predictor = {
  tolkienNames: new Markov(),
  tolkienPlaces: new Markov(),
  spanishNames: new Markov(),
  spanishPlaces: new Markov(),
}
predictor.tolkienNames.trainModel(trainData.tolkienNames)
predictor.tolkienPlaces.trainModel(trainData.tolkienPlaces)
